...
class LatestChampionship extends Component {
  constructor(props) {
    super(props)
  }

  render() {
    const { time, firstName, lastName, constructorName, averageSpeed } = this.props

    return (
      <View style={ styles.latestChampionship }>
        <View style={ styles.titleBox }>
          <ScalableText style={ styles.titleTxt }>Latest Championship</ScalableText>
        </View>
        <View style={ styles.row }>
          <View style={ styles.flex }>
            <ScalableText style={ styles.name }>{ firstName } { lastName }</ScalableText>
...
module.exports = LatestChampionship
